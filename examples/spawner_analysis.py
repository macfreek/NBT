#!/usr/bin/env python
"""
Finds and prints the type of mob spawners
"""
...
world_folder = '/Users/freek/Library/Application Support/minecraft/saves/minecraft.chilliserver.com - Villa world'
from nbt.world import WorldFolder
world = WorldFolder(world_folder)
len(world.regionfiles)
c = world.get_nbt(0,0)
print c.pretty_tree()
